// declare the array with the name data:
var data = [ // arrays are represented with square brackets. 
  {// record entire events within curly brackets, using a key-value pair format. 
    datetime: "1/1/2010",
    city: "benton",
    state: "ar",
    country: "us",
...
]; // semi colon is used to signal the completed code block
